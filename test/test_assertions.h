...
struct test_assertions : unittest::testcase<> {
    ...
    static void run()
    {
        UNITTEST_RUN(test_assertions, test_assert_true)
        UNITTEST_RUN(test_assertions, test_assert_false)
        UNITTEST_RUN(test_assertions, test_assert_equal)
        UNITTEST_RUN(test_assertions, test_assert_not_equal)
        UNITTEST_RUN(test_assertions, test_assert_approx_equal)
        ...
        UNITTEST_RUN(test_assertions, test_assert_not_in_container)
        UNITTEST_RUN(test_assertions, test_assert_approx_in_container)
        UNITTEST_RUN(test_assertions, test_assert_approx_not_in_container)
        UNITTEST_RUN(test_assertions, test_assert_equal_containers)
        UNITTEST_RUN(test_assertions, test_assert_not_equal_containers)
        UNITTEST_RUN(test_assertions, test_assert_approx_equal_containers)
        UNITTEST_RUN(test_assertions, test_assert_approx_not_equal_containers)
        UNITTEST_RUN(test_assertions, test_assert_all_of)
        UNITTEST_RUN(test_assertions, test_assert_not_all_of)
        UNITTEST_RUN(test_assertions, test_assert_any_of)
        UNITTEST_RUN(test_assertions, test_assert_none_of)
        UNITTEST_RUN(test_assertions, test_assert_regex_match)
        UNITTEST_RUN(test_assertions, test_assert_not_regex_match)
        UNITTEST_RUN(test_assertions, test_assert_throw)
        UNITTEST_RUN(test_assertions, test_assert_no_throw)
    }
